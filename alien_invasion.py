...
def run_game(): # 定义一个方法
    ...
    # 开始游戏的主循环
    while True:
        gf.check_events(ai_settings, screen, stats, play_button, ship, aliens, bullets) # 创建玩家的输入
        ...
        gf.update_screen(ai_settings, screen, stats, ship, aliens, bullets, play_button)    # 更新后的位置绘制新屏幕
